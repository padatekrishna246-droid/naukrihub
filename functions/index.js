...
const { processJob } = require("./ai-process-job-core");
...
/*
==========================================
AUTOMATIC AI JOB PROCESSING
==========================================
*/

exports.processNewJob = onDocumentCreated(
    "jobs/{jobId}",
    async (event) => {
        ...
        try {
            ...
            console.error(
                `AI processing failed for ${jobId}:`,
                error.message
            );
